    ...
    <div id="about" className="w-full md:h-screen p-2 flex items-center py-16">
      <div className="max-w-[1240px] m-auto md:grid grid-cols-3 gap-8">
        <div className="col-span-2">
          ...
          <p className="py-2 text-gray-600">
            I have spent the last 12 years working as a professional in Human
            Resources and finished a Master's degree in Clinical Mental Health
            Counseling. I have always enjoyed technology and working with
            computers. In 2020 I built my own computer and in 2021 I started
            learning some basic HTML & CSS because I thought it would be fun to
            make websites and potentially help me start my own business one day.
            I quickly became hooked, (react pun intended) and my passion for
